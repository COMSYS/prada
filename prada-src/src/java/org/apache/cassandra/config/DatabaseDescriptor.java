...
public class DatabaseDescriptor
{
        ...
        localComparator = new Comparator<InetAddress>()
        {
            public int compare(InetAddress endpoint1, InetAddress endpoint2)
            {
                ...
                if (endpoint1.equals(endpoint2))
                    return 0;
                if (endpoint1.equals(FBUtilities.getBroadcastAddress()))
                    return -1;
                if (endpoint2.equals(FBUtilities.getBroadcastAddress()))
                    return 1;
                return 0;
            }
        };
    ...
    public static int getConcurrentIndRefWorkers()
    {
        return conf.concurrent_ind_ref_workers;
    }

    public static int getConcurrentIndDeleteWorkers()
    {
        return conf.concurrent_ind_delete_workers;
    }

    public static int getConcurrentIndDataWorkers()
    {
        return conf.concurrent_ind_data_workers;
    }
    ...
    public static int getLoadBroadcastInterval()
    {
        return conf.load_broadcast_interval;
    }
}
