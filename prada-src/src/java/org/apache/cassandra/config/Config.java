...
public class Config
{
    ...
    public Integer concurrent_ind_ref_workers = 16;
    public Integer concurrent_ind_delete_workers = 16;
    public Integer concurrent_ind_data_workers = 16;
    ...
    public int load_broadcast_interval = 60000;
