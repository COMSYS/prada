...
public class StageManager
{
    ...
    static
    {
        ...
        // Data Annotations
        stages.put(Stage.INDIRECTION_DATA_MESSAGE, multiThreadedConfigurableStage(Stage.INDIRECTION_DATA_MESSAGE, getConcurrentIndDataWorkers()));
        stages.put(Stage.INDIRECTION_DELETE_MESSAGE, multiThreadedConfigurableStage(Stage.INDIRECTION_DELETE_MESSAGE, getConcurrentIndDeleteWorkers()));
        stages.put(Stage.INDIRECTION_UPDATE_REFERENCES_MESSAGE, multiThreadedConfigurableStage(Stage.INDIRECTION_UPDATE_REFERENCES_MESSAGE, getConcurrentIndRefWorkers()));
    }
