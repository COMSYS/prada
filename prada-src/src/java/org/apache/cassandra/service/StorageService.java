...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.INDIRECTION_DATA_MESSAGE, new IndirectionDataVerbHandler());
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.INDIRECTION_DELETE_MESSAGE, new IndirectionDeleteVerbHandler());
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.INDIRECTION_UPDATE_REFERENCES_MESSAGE, new IndirectionUpdateReferencesVerbHandler());
    }
            ...
            else
            {
                if (!DatabaseDescriptor.getReplaceAddress().equals(FBUtilities.getBroadcastAddress()))
                {
                    try
                    {
                        ...
                        Thread.sleep(DatabaseDescriptor.getLoadBroadcastInterval());
                    }
    ...
    public InetAddress getAssociatedEndpoint(String t)
    {
        return getAssociatedEndpoint(getPartitioner().getTokenFactory().fromString(t));
    }

    public InetAddress getAssociatedEndpoint(Token t)
    {
        return tokenMetadata.getAssociatedEndpoint(t);
    }
