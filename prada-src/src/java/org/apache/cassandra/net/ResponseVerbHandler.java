...
public class ResponseVerbHandler implements IVerbHandler
{
    ...
    public void doVerb(MessageIn message, int id)
    {
        ...
        if (message.dropCBImmediately())
            callbackInfo = MessagingService.instance().removeRegisteredCallback(id);
        else
            callbackInfo = MessagingService.instance().getRegisteredCallback(id);
        ...
        cb.response(message);
        if (!message.dropCBImmediately() && cb.done())
        {
