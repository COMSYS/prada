...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    public enum Verb
    {
        ...
        UNUSED_2,
        UNUSED_3,
        INDIRECTION_DATA_MESSAGE,
        INDIRECTION_DELETE_MESSAGE,
        INDIRECTION_UPDATE_REFERENCES_MESSAGE
        ;
    }
    ...
    {{
        ...
        put(Verb.INDIRECTION_DATA_MESSAGE, Stage.INDIRECTION_DATA_MESSAGE);
        put(Verb.INDIRECTION_DELETE_MESSAGE, Stage.INDIRECTION_DELETE_MESSAGE);
        put(Verb.INDIRECTION_UPDATE_REFERENCES_MESSAGE, Stage.INDIRECTION_UPDATE_REFERENCES_MESSAGE);
    }};
    ...
    {{
        ...
        put(Verb.INDIRECTION_DATA_MESSAGE, IndirectionMessage.serializer);
        put(Verb.INDIRECTION_DELETE_MESSAGE, IndirectionMessage.serializer);
        put(Verb.INDIRECTION_UPDATE_REFERENCES_MESSAGE, IndirectionMessage.serializer);
    }};
    ...
    {{
        ...
        put(Verb.INDIRECTION_UPDATE_REFERENCES_MESSAGE, IndirectionMessage.serializer);
        put(Verb.INDIRECTION_DATA_MESSAGE, IndirectionDataMessage.serializer);
        put(Verb.INDIRECTION_DELETE_MESSAGE, IndirectionMessage.serializer);
    }};
